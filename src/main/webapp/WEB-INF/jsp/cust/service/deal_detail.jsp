...
<body>
<div class="easyui-panel" title="客户服务管理&nbsp;&gt; 客户服务管理" style="width:1200px;height: 1000px;">
	<form id="ff" method="post" style="padding-left: 20px;">
		...
		<div style="margin-bottom:20px">
			<input class="easyui-textbox"  name="svrDeal" style="width:30%" data-options="label:'服务处理:'">
		</div>
		<div style="margin-bottom:20px">
...
<script>
    ...
    function submitFormAjax() {
        ...
        alert(options.val());
//        alert($("select[name='svrSatisfy']").val());
		$.ajax({
			//几个参数需要注意一下
			type: "POST",//方法类型
			...
			data: {
                ...
                svrDeal : $('input[name=svrDeal]').val(),
                svrSatisfy : options.val()
            },
			url:'service/editServiceDeal',//url
			success: function (result) {
                //更新指定的选项卡
                parent.refreshByService();
                //定义窗口属性
//                var title ='服务反馈';
//                var url = 'input/cust/service/feedback';
//                var iconCls = '';
//                var iframe = true;
//				//打开一个新的窗口
