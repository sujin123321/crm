...
<script type="text/javascript">
        ...
        $('#dg').datagrid( {
            ...
            columns : [ [ {
                ...
                formatter: function (value, row, index) {
                    var str =
                        '<img onclick="deal()" title="处理" src="images/bt_deal.gif" class="op_button" name="zp" />';
                    return str;
                }
            }
            ] ]
    ...
    function deal() {
        ...
        //alert(svrId);
		parent.addTab('执行','input/cust/service/deal_detail?svrId='+svrId+'','',true);
    }
